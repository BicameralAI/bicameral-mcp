...
async def test_learner_persists_results_to_learned_heuristic_terms_table():
    ...
    try:
        ...
        rows = await client.query(
            "SELECT term, support_count FROM learned_heuristic_terms WHERE source_type = 'slack'"
        )
